...
const { sessionCourse } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('sessionCourse');

// This file contains the logic of every route in Forest Admin for the collection sessionCourse:
...
router.post('/sessionCourse', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Session Course
router.put('/sessionCourse/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Session Course
router.delete('/sessionCourse/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Session Courses
router.get('/sessionCourse', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Session Courses
router.get('/sessionCourse/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Session Course
router.get('/sessionCourse/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Session Courses
router.get('/sessionCourse.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Session Courses
router.delete('/sessionCourse', permissionMiddlewareCreator.delete(), (request, response, next) => {
