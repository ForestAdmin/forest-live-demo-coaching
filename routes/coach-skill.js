...
const { coachSkill } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('coachSkill');

// This file contains the logic of every route in Forest Admin for the collection coachSkill:
...
// Create a Coach Skill
router.post('/coachSkill', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Coach Skill
router.put('/coachSkill/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
// Delete a Coach Skill
router.delete('/coachSkill/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Coach Skills
router.get('/coachSkill', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Coach Skills
router.get('/coachSkill/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Coach Skill
router.get('/coachSkill/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Coach Skills
router.get('/coachSkill.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Coach Skills
router.delete('/coachSkill', permissionMiddlewareCreator.delete(), (request, response, next) => {
