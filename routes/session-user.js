...
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('sessionUser');

// This file contains the logic of every route in Forest Admin for the collection sessionUser:
...
router.post('/sessionUser', permissionMiddlewareCreator.create(), (request, response, next) => {
...
// Update a Session User
router.put('/sessionUser/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/sessionUser/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
// Get a list of Session Users
router.get('/sessionUser', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Session Users
router.get('/sessionUser/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Session User
router.get('/sessionUser/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Session Users
router.get('/sessionUser.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Session Users
router.delete('/sessionUser', permissionMiddlewareCreator.delete(), (request, response, next) => {
