...
const { sessionType } = require('../models');

const router = express.Router();
const permissionMiddlewareCreator = new PermissionMiddlewareCreator('sessionType');

// This file contains the logic of every route in Forest Admin for the collection sessionType:
...
router.post('/sessionType', permissionMiddlewareCreator.create(), (request, response, next) => {
...
router.put('/sessionType/:recordId', permissionMiddlewareCreator.update(), (request, response, next) => {
...
router.delete('/sessionType/:recordId', permissionMiddlewareCreator.delete(), (request, response, next) => {
...
router.get('/sessionType', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a number of Session Types
router.get('/sessionType/count', permissionMiddlewareCreator.list(), (request, response, next) => {
...
// Get a Session Type
router.get('/sessionType/\\b(?!count\\b):recordId', permissionMiddlewareCreator.details(), (request, response, next) => {
...
// Export a list of Session Types
router.get('/sessionType.csv', permissionMiddlewareCreator.export(), (request, response, next) => {
...
// Delete a list of Session Types
router.delete('/sessionType', permissionMiddlewareCreator.delete(), (request, response, next) => {
